...
import com.stelmashchuk.remark.storage.SystemStorageImpl
...
public object RemarkComponent {
  ...
  internal val api: RemarkApi by lazy { RemarkApi(remarkSettings.siteId, remarkSettings.baseUrl, SystemStorageImpl(BinaryPreferencesBuilder(context).build())) }
